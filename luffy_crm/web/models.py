...
class ClassList(models.Model):
    ...
    class_teacher = models.ForeignKey(verbose_name='班主任', to='UserInfo', on_delete=models.CASCADE, related_name='classes',
...
class Customer(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问",
                                   to='UserInfo',
                                   on_delete=models.CASCADE,
...
class PaymentRecord(models.Model):
    ...
    consultant = models.ForeignKey(verbose_name="课程顾问", to='UserInfo', on_delete=models.CASCADE, help_text="谁签的单就选谁")
    pay_type_choices = [
        (1, "报名费"),
        (2, "学费"),
        (3, "退学"),
    ...
    confirm_user = models.ForeignKey(verbose_name="审批人", to='UserInfo', on_delete=models.CASCADE, related_name='confirms', null=True, blank=True)
